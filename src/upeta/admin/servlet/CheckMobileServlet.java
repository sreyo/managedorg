...
/**
 * Servlet implementation class CheckMobileServlet
 */
...
public class CheckMobileServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		/*
		 * HttpSession session = request.getSession(true); String hostname = (String)
        ...
        String val =  Memberdao.checkmob(mobile,hostname); 
